...
%% Version 2019053000
%% Created Sun Feb 21 2021 12:35:39 GMT-0600
%% Last revised Sun Feb 21 2021 12:35:39 GMT-0600
...
\graphicspath{{Pendulodoble_graphics/}{Pendulodoble_tcache/}{Pendulodoble_gcache/}}
...
\begin{document}$m_{b 1} (\frac{1}{2} \ast l_{1} \ast \varpi _{1} \ast \cos  \theta _{1})^{2} =\frac{1}{4} m_{b 1} l_{1}^{2} \varpi _{1}^{2} \cos ^{2} \theta _{1}$ 

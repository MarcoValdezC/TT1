...
#---------------------Parametros DE-----------------------------#
limit= [(0, 5),(0, 3)]                  #Limites inferior y superior
...
D = 2    # Dimensionalidad O número de variables de diseño 
...
var=main(Bihn, limit, poblacion, f_mut, recombination, generaciones)